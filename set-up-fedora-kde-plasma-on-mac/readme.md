...
- Enable two finger pinch zoom
  ...
  - select "Wayland"
- Disable two finger swipe
  - go to "chrome://settings/appearance"
  - search for "Swipe between pages"
...
$ git clone https://github.com/cseelus/monego.git

$ fc-cache -f -v
$ fc-list : family | grep -i monego
```
...
> 
>
> `plasma-workspace` has been customized to tap into the "General" font
